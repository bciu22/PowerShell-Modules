...
Try {
	...
	[string]$appName = 'E5470 1.10.5 BIOS'
	[string]$appVersion = '1.10.5'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '20161109'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$results = Execute-Process -Path 'Latitude_E5x70_Precision_3510_1.10.5.exe' -Parameters '/s /l=C:\Windows\Logs\Software\E5470_1.10.5_BIOS_Update.txt /p=PASSWORD' -PassThru
